IF OBJECT_ID('[dbo].[PT_S_PT_DATA_Products]') IS NOT NULL
	DROP PROCEDURE [dbo].[PT_S_PT_DATA_Products];
...
CREATE PROCEDURE [dbo].[PT_S_PT_DATA_Products]
(
	@ID					int,
    @Name				varchar(50),
    @CategoryID			int
